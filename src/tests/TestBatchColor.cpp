...
namespace test {
    ...
    TestBatchColor::TestBatchColor() : m_TranslationA(200, 200, 0), m_TranslationB(500, 200, 0),
        m_Proj(glm::ortho(0.0f, 960.0f, 0.0f, 540.0f, -1.0f, 1.0f)), m_View(glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, 0)))
    {
        float vertices[] = {
            -50.0f, -50.0f, 0.396f, 0.263f, 0.129f, 1.0f,
             50.0f, -50.0f, 0.396f, 0.263f, 0.129f, 1.0f,   
             50.0f,  50.0f, 0.396f, 0.263f, 0.129f, 1.0f,   
            -50.0f,  50.0f, 0.396f, 0.263f, 0.129f, 1.0f,   

            150.0f, -50.0f, 0.71f, 0.40, 0.11f, 1.0f, 
            250.0f, -50.0f, 0.71f, 0.40, 0.11f, 1.0f, 
            250.0f,  50.0f, 0.71f, 0.40, 0.11f, 1.0f, 
            150.0f,  50.0f, 0.71f, 0.40, 0.11f, 1.0f,
        };
        ...
        m_VertexBuffer = std::make_unique<VertexBuffer>(vertices, 6 * 8 * sizeof(GLfloat)); // Instantiate a buffer with the positions and binds it by default
